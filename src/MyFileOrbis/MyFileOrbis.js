...
{
  const { rootFolderId, setRootFolderId, mainFolderId } = props;
    ...
    <div>
      ...
      {clicked ? 
        <Toolbar sx={{ display: 'flex', alignItems: 'center'}}>
          ...
          />
          <DownloadTwoToneIcon sx={{ marginRight: '25px', cursor:'pointer' }} />
          <StarRateTwoToneIcon sx={{ marginRight: '25px', cursor:'pointer' }} />
          <ShareTwoToneIcon sx={{ marginRight: '25px', cursor:'pointer' }} />
          <DeleteTwoToneIcon sx={{cursor:'pointer'}} />
        </Toolbar> : 
